...
import { BookOpen, Image, Cat, Bell, Camera } from "lucide-react";
...
export const CollectionNav: React.FC<CollectionNavProps> = ({
    ...
    const tabs = [
        { id: "zukan", label: "コレクション", icon: BookOpen },
        { id: "photo", label: "フォト", icon: Image },
        { id: "camera", label: "きろく", icon: Camera, isCenter: true },
        { id: "care", label: "うちの子", icon: Cat },
