...
### タスク4: ポーズ判定
画像の猫の体勢・ポーズを以下から**最も近いものを1つ**選んでください。
- **香箱座り**: 前足を体の下に折りたたんで座る（catloaf）
- **へそ天**: 仰向けでお腹を見せている
- **スフィンクス**: 前足を前に伸ばして伏せる
- **まんまる**: 丸まっている（寝ている時含む）
- **にょろーん**: 長く伸びている
- **ちょこん座り**: 背筋を伸ばして座っている
- **箱イン**: 箱・袋・容器に入っている
- **ふみふみ**: 前足を交互に動かしている（ニーディング）
- **その他**: 上記に当てはまらない（動いている、歩いている等）
...

{
  ...
  "pose": "香箱座り|へそ天|スフィンクス|まんまる|にょろーん|ちょこん座り|箱イン|ふみふみ|その他",
