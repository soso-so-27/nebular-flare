            ...
            <div className="p-4 space-y-4 max-h-[480px] overflow-y-auto no-scrollbar">
                ...
                <AnimatePresence mode="wait">
                    {activeTab === 'notifications' ? (
                                    ...
                                    <div className="space-y-2">
                                        {alertItems.map(item => (
                                            <motion.button
                                                ...
                                                className="w-full text-left p-3 rounded-xl bg-gradient-to-br from-brand-peach/20 to-brand-peach/40 border border-brand-peach/30 flex items-start gap-3 backdrop-blur-sm shadow-md transition-colors hover:border-brand-peach/50"
                                            >
                        ...
                        >
                            {/* 2. Care Header */}
                            <div className="flex items-center gap-2 text-brand-peach text-xs font-bold pl-1">
                                <Cat className="w-3 h-3 text-brand-peach" />
                                <span>今日のリクエスト</span>
                                ...
                                {careItems.map(item => (
                                    ...
                                    >
                                        ...
                                        <div className={`w-5 h-5 rounded-full border flex items-center justify-center flex-shrink-0 transition-colors ${(item.done || pendingIds.has(item.id))
                                            ...
                                            : item.priority === 'high'
                                                ? 'border-red-500/50'
                                                : 'border-brand-peach/40 group-hover:border-brand-peach'
                                            }`}>
