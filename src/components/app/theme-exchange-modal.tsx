...
import { MedicalReportView } from "./medical-report-view";
import { WeeklyPageClient } from "./weekly-page-client";
                                    ...
                                    {activeTab === 'layout' ? (
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                {/* 受診用レポート - Active */}
                                                <div className="p-4 rounded-xl bg-white/5 border border-[#E8B4A0]/30 shadow-[0_0_10px_rgba(232,180,160,0.1)]">
                                                    <div className="flex items-center justify-between">
                                                        <div>
                                                            <div className="flex items-center gap-2">
                                                        ...
                                                        <button
                                                            className="px-3 py-1.5 text-xs font-bold rounded-lg transition-colors bg-[#E8B4A0] text-slate-900 hover:bg-[#E8B4A0]/90"
