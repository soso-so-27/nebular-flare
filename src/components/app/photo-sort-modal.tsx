                        ...
                        >
                                ...
                                {analyzing && (
                                    <div className="absolute inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-10">
                                        <div className="bg-white/10 backdrop-blur-md rounded-xl px-6 py-4 flex flex-col items-center gap-3">
                                            <Loader2 className="h-8 w-8 animate-spin text-[#B8A6D9]" />
                            ...
                            {suggestedCat && !analyzing && (
                                <div className="px-4 pb-2 shrink-0">
                                    <div className="bg-[#B8A6D9]/20 backdrop-blur-md rounded-xl p-3 flex items-center gap-3 border border-[#B8A6D9]/30">
                                        ...
                                        <button
                                            ...
                                            className="px-4 py-1.5 rounded-full bg-[#B8A6D9] text-white text-sm font-bold shadow-lg shadow-[#B8A6D9]/20"
                                        >
                                            はい
                                        </button>
                                    </div>
