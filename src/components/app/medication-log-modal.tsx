...
export function MedicationLogModal({ isOpen, onClose, catId }: MedicationLogModalProps) {
    ...
    const startEdit = (log: MedicationLog) => {
        ...
        setStartDate(log.start_date.split('T')[0]);
            ...
            {isOpen && (
                ...
                >
                    <motion.div
                        ...
                        className="bg-[#FAF9F7] dark:bg-[#1E1E23] w-full max-w-sm max-h-[85vh] sm:rounded-2xl rounded-t-2xl overflow-hidden shadow-2xl flex flex-col"
                    >
                        {/* Header */}
