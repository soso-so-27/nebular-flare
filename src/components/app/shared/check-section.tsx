                ...
                <div className="divide-y divide-slate-100 dark:divide-slate-800">
                    ...
                    {pendingObservationItems.map(item => (
                        ...
                        >
                            ...
                            <button
                                onClick={item.onAction}
                                className="text-xs font-bold px-4 py-1.5 rounded-full bg-brand-sage/10 text-brand-sage hover:bg-brand-sage/20 active:bg-brand-sage/30 active:scale-95 transition-all"
                            >
                                確認済
                            </button>
                        </div>
                        ...
                        >
                            <div className="flex items-center gap-2">
                                ...
                                <span className={cn(
                                    ...
                                    item.stockLevel === 'empty' ? "bg-brand-lavender/10 text-brand-lavender" : "bg-brand-peach/10 text-brand-peach"
                                )}>
                            ...
                            <button
                                onClick={item.onAction}
                                className="text-xs font-bold px-4 py-1.5 rounded-full bg-brand-peach/10 text-brand-peach hover:bg-brand-peach/20 active:bg-brand-peach/30 active:scale-95 transition-all"
                            >
                                補充済み
                            </button>
                        </div>
