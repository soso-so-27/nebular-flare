                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        <LineChart data={displayData} margin={{ top: 5, right: 5, left: -20, bottom: 5 }}>
                            ...
                            <Line
                                type="monotone"
                                dataKey="weight"
                                stroke={isGlass ? "var(--color-brand-sage)" : "var(--color-brand-sage)"}
                                strokeWidth={2}
                                dot={{ fill: isGlass ? "var(--color-brand-sage)" : "var(--color-brand-sage)", strokeWidth: 0, r: 4 }}
                                activeDot={{ r: 6, fill: isGlass ? "#fff" : "var(--color-brand-sage)" }}
                            />
                        </LineChart>
                    </ResponsiveContainer>
                </div>
                        ...
                        >
                            ...
                            <div className="flex gap-2 mt-4">
                                ...
                                <button
                                    ...
                                    className="flex-1 py-2 rounded-xl bg-brand-sage text-white text-sm font-bold disabled:opacity-50"
                                >
                                    保存
                                </button>
                            </div>
