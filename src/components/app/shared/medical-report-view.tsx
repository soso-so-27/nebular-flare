    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex justify-end">
                <Button onClick={handleExport} className="gap-2 bg-brand-sage hover:bg-brand-sage/90 text-white">
                                ...
                                <div key={log.id} className="p-2 bg-blue-50/50 rounded-lg border border-blue-100 text-[12px] flex items-start gap-2">
                                    ...
                                    <div className="flex-1 flex flex-wrap gap-x-3 gap-y-1 text-slate-500">
                                        ...
                                        <span className="text-[10px] text-slate-400">
                                            {format(new Date(log.starts_at), 'M/d')} 〜 {log.end_date ? format(new Date(log.end_date), 'M/d') : '継続中'}
                                        </span>
                                    </div>
                                </div>
                            ))}
