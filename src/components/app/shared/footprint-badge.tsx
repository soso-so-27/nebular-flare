...
export function FootprintBadge({ className = '', variant = 'compact', onClick }: FootprintBadgeProps) {
        ...
        return (
            ...
            >
                ...
                <div className="flex flex-col">
                    <div className="flex text-xl font-bold text-brand-sage">
    ...
    return (
        ...
        >
            ...
            {/* Point count badge */}
            <motion.div
                className="absolute -bottom-1 -right-1 min-w-[20px] h-[20px] px-1 rounded-full bg-brand-peach flex items-center justify-center shadow-md ring-2 ring-white"
