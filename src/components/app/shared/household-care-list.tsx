        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-sm overflow-hidden">
            ...
            <div className="px-5 py-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-xl bg-brand-sage/10 dark:bg-brand-sage/20 flex items-center justify-center">
                        <Home className="h-4 w-4 text-brand-sage dark:text-brand-sage" />
                    </div>
                    ...
                    {careItems.map((item, i) => (
                        <div
                            ...
                            className={cn(
                                ...
                                item.done
                                    ? "bg-brand-sage dark:bg-brand-sage"
