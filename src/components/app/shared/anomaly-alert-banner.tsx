...
import { useCatContext, useCareContext } from "@/store/app-store";
...
export function AnomalyAlertBanner() {
    ...
    const { noticeLogs } = useCareContext();
        ...
        <div className="space-y-2">
            {visibleAnomalies.map((anomaly, idx) => (
                <div
                    ...
                    className="bg-gradient-to-r from-brand-lavender to-purple-400 text-white rounded-2xl p-4 shadow-lg"
                >
