            ...
            {isOpen && (
                <div className="fixed inset-0 z-[10002] flex items-center justify-center">
                    ...
                    >
                        ...
                        >
                            {/* Header */}
                            <div className="px-4 py-3 flex items-center justify-between bg-black/80 backdrop-blur shrink-0 safe-area-pt">
                                <button onClick={onClose} className="text-white p-2">
                                    <X className="h-6 w-6" />
                                </button>
                                <div className="flex items-center gap-2 text-white">
                                    <Wand2 className="h-4 w-4 text-brand-lavender" />
                            ...
                            <div className="flex-1 flex items-center justify-center p-4 relative overflow-hidden">
                                ...
                                {analyzing && (
                                    <div className="absolute inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-10">
                                        <div className="bg-white/10 backdrop-blur-md rounded-xl px-6 py-4 flex flex-col items-center gap-3">
                                            <Loader2 className="h-8 w-8 animate-spin text-brand-lavender" />
                                            <span className="text-white text-sm font-medium">猫を識別中...</span>
                                        </div>
                                    </div>
                                )}
                            </div>
                            ...
                            {suggestedCat && !analyzing && (
                                <div className="px-4 pb-2 shrink-0">
                                    <div className="bg-brand-lavender/20 backdrop-blur-md rounded-xl p-3 flex items-center gap-3 border border-brand-lavender/30">
                                        ...
                                        <button
                                            ...
                                            className="px-4 py-1.5 rounded-full bg-brand-lavender text-white text-sm font-bold shadow-lg shadow-brand-lavender/20"
                                        >
                                            はい
                                        </button>
                                    </div>
                            ...
                            {/* Cat Selection */}
                            <div className="p-4 bg-black/80 backdrop-blur flex-shrink-0 safe-area-pb">
                                ...
                                <div className="flex gap-4 justify-center flex-wrap">
                                    {cats.map(cat => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="w-14 h-14 rounded-full overflow-hidden bg-slate-700 flex items-center justify-center border-2 border-transparent hover:border-white/50 transition-colors">
                                                    {hasAvatar ? (
                                ...
                                <button
                                    onClick={handleSkip}
                                    className="w-full mt-6 py-3 text-white/40 text-sm hover:text-white/70 transition-colors"
                                >
                                    スキップ
                                </button>
                            </div>
