                    ...
                    >
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex gap-3 overflow-x-auto py-2 no-scrollbar min-h-[140px]">
                                    ...
                                    >
                                        ...
                                        <span className="text-[10px] font-bold text-brand-peach">追加</span>
                                    </button>
                                </div>
                        ...
                        <div className="p-6 pt-2 shrink-0 border-t border-white/5">
                            <div className="flex gap-3">
                                ...
                                <Button
                                    onClick={handleSave}
                                    className="flex-[2] rounded-full bg-brand-peach hover:bg-brand-peach/90 text-white shadow-lg shadow-brand-peach/20 border-none"
