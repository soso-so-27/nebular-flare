            ...
            {isOpen && (
                <div className="fixed inset-0 z-[10002] flex items-end justify-center sm:items-center">
                    ...
                    <motion.div
                        ...
                        className="bg-background/90 backdrop-blur-xl border border-white/40 shadow-2xl w-full max-w-md max-h-[90vh] sm:rounded-2xl rounded-t-[32px] overflow-hidden flex flex-col relative"
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                ...
                                                {records.some(r => isAbnormal(r.value)) && (
                                                    <AlertTriangle className="h-3.5 w-3.5 text-brand-lavender" />
                                                )}
                                            </div>
