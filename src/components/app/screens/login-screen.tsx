    ...
    return (
        <div className="min-h-full bg-gradient-to-br from-background via-slate-50 to-slate-100 flex flex-col items-center justify-center p-6">
            ...
            <div className="flex items-center gap-3 mb-8">
                <div className="h-14 w-14 rounded-2xl bg-gradient-to-br from-brand-sage to-emerald-600 flex items-center justify-center shadow-lg">
                    ...
                    {isSignUp && (
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-3 rounded-xl bg-slate-50 border-none text-sm focus:ring-2 focus:ring-brand-sage placeholder:text-slate-400"
                                required
                            />
                        </div>
                    )}
