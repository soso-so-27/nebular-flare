    ...
    if (!user) {
        return (
            <div className="relative">
                {/* Overlay Message */}
                <div className="absolute top-0 left-0 right-0 z-10 bg-brand-sage text-white p-4 text-center text-sm font-bold shadow-md">
    ...
    return (
        <div className="min-h-full bg-gradient-to-br from-background via-slate-50 to-slate-100 flex flex-col items-center justify-center p-6">
            <div className="w-full max-w-sm bg-white rounded-3xl shadow-xl p-8 space-y-6 text-center">
                ...
                {status === 'loading' && (
                    <div className="py-10">
                        <Loader2 className="h-10 w-10 animate-spin text-brand-sage mx-auto" />
                ...
                {status === 'valid' && (
                    <div className="space-y-6">
                        <div className="h-20 w-20 bg-gradient-to-br from-brand-sage to-emerald-600 rounded-2xl flex items-center justify-center mx-auto shadow-lg shadow-brand-sage/30">
                        ...
                        <div className="space-y-3 pt-2">
                            <Button
                                onClick={() => handleJoin()}
                                className="w-full h-14 text-lg rounded-2xl bg-gradient-to-r from-brand-sage to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-bold shadow-lg shadow-brand-sage/30"
                            >
                                参加する
                            </Button>
                            <Button
