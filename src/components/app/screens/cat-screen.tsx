...
import { WeightChart } from "../shared/weight-chart";
import { CatEditModal } from "../modals/cat-edit-modal";
    ...
    if (cats.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center py-12 text-center h-full">
                <div className="h-16 w-16 rounded-full bg-brand-sage/10 flex items-center justify-center mb-4">
                    <CatIcon className="h-8 w-8 text-emerald-700" />
                </div>
            ...
            <div className="relative z-10 h-screen overflow-y-auto overflow-x-hidden pb-32 scrollbar-hide">
                        ...
                        {cats.map(cat => (
                            <button
                                ...
                                className={cn(
                                    ...
                                    activeCatId === cat.id
                                        ? "scale-110 ring-2 ring-brand-sage z-10"
                ...
                <div className="px-4 space-y-4">
                    ...
                    >
                        ...
                        <div className="absolute -top-10 -right-10 w-32 h-32 bg-brand-lavender/10 rounded-full blur-3xl pointer-events-none" />
                    ...
                    <div className="grid grid-cols-1 gap-3">
                        ...
                        >
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <span className="text-[10px] bg-brand-sage/20 text-brand-sage px-2 py-0.5 rounded-full font-bold">ACTIVE</span>
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-3">
                                ...
                                <div className="flex items-center justify-between p-3 bg-white/5 rounded-2xl border border-white/5">
                                    <div className="flex items-center gap-3">
                                        <div className="w-8 h-8 rounded-xl bg-brand-sage/20 flex items-center justify-center">
                                            <Syringe className="w-4 h-4 text-brand-sage" />
                                        </div>
                                        <div>
                                    ...
                                    <div className="text-right">
                                        ...
                                        <div className="text-[10px] font-black text-brand-sage/60">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        >
                            <div className="w-10 h-10 rounded-2xl bg-white/5 flex items-center justify-center text-brand-lavender mb-1">
                        ...
                        <motion.div
                            ...
                            className="rounded-3xl bg-black/20 backdrop-blur-lg border border-white/10 p-4 shadow-lg flex flex-col items-center justify-center text-center gap-2"
                        >
                            <div className="w-10 h-10 rounded-2xl bg-white/5 flex items-center justify-center text-brand-sage mb-1">
