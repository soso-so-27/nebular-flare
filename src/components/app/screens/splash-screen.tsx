    ...
    return (
        <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-background select-none overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-brand-peach/20 rounded-full blur-3xl animate-pulse" />
                <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-brand-sage/20 rounded-full blur-3xl animate-pulse delay-1000" />
            </div>
            ...
            >
                ...
                <div className="mt-8 flex flex-col items-center gap-3">
                    ...
                    <motion.p
                        ...
                        className="mt-4 text-[10px] font-bold tracking-[0.2em] text-brand-sage/60 animate-pulse"
                    >
                        LOADING...
                    </motion.p>
                </div>
