-- migration for safely consuming footprints
...
BEGIN
  ...
  -- This ensures we have the true balance before any deduction
  ...
  INSERT INTO cat_footprints (user_id, household_id, cat_id, action_type, amount, memo, earned_at)
