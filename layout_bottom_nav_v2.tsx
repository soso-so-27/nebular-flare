                    ...
                    <div className="flex items-center justify-around">
                        ...
                        {!ENABLE_INTEGRATED_PICKUP && (
                            ...
                            >
                                ...
                                <span className="text-[10px] text-slate-500">繝斐ャ繧ｯ繧｢繝・・</span>
                            </motion.button>
                        )}
                        ...
                        >
                            ...
                            <span className="text-[10px] text-slate-500">雜ｳ縺ゅ→</span>
                        </motion.button>
                        ...
                        >
                            ...
                            <span className="text-[10px] text-slate-500">莉頑律縺ｮ荳譫・/span>
                        </motion.button>
                        ...
                        >
                            ...
                            <span className="text-[10px] text-slate-500">繝｡繝九Η繝ｼ</span>
                        </motion.button>
                    </div>
                </div>
            </motion.div>
